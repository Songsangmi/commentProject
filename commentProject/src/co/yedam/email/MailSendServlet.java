...
public class MailSendServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Authenticator auth = new MyAuthentication("ciaowon2", "wldnjs@9061");
		...
		try {
			...
			from = new InternetAddress("ciaowon2@naver.com");
			msg.setFrom(from);

			InternetAddress to = new InternetAddress("ciaowon2@naver.com");
